...
describe("DELETE /bookings/{booking_id} (cancel_booking_bookings__booking_id__delete)", () => {
  const BASE_URL = "http://localhost:8006";
  const ENDPOINT = "/bookings/{booking_id}";
  const METHOD: string = "DELETE";  // Typed as string to allow runtime comparisons
