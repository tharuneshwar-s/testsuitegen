...
def test_data_setup(api_client):
    ...
    response = api_client.post(f"{BASE_URL}/users", json=happy_path_payload)
    if response.status_code == 201:
        created_resources.append(
            {
                "type": "user",
                "id": response.json()["id"],
                "endpoint": f"{BASE_URL}/users/{response.json()['id']}",
            }
        )
...
class TestCreate_user_profile_users_profile_post:
        ...
        [
            pytest.param(
                "HAPPY_PATH",
                {
                    ...
                    "bio": "A software engineer with over 10 years of experience.",
            ...
            pytest.param(
                "BOUNDARY_MAX_LENGTH_PLUS_ONE",
                {
                    "username": "alice.smith",
                    "email": "alice.smith@domain.com",
                    "full_name": "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
                    "bio": "A software engineer with over 10 years of experience.",
                    "website": "https://www.alicesmith.com",
                },
                {},
            ...
            pytest.param(
                "BOUNDARY_MAX_LENGTH_PLUS_ONE",
                {
                    ...
                    "email": "alice.smith@domain.com",
                    "full_name": "Alice Smith",
                    "bio": "",
                    "website": "https://www.alicesmith.com",
                },
                {},
                422,
    ...
    def test_create_user_profile_users_profile_post_contract(
