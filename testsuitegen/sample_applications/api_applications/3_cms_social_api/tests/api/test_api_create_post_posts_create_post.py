...
def test_data_setup(api_client):
    ...
    # Create test post for happy path
    happy_path_payload = {
        "title": "Test Post for Setup",
        "content": "Created by test fixture",
        "status": "DRAFT",
        "tags": ["Test", "Fixture"],
        "category": "Tutorials",
    }
    response = api_client.post(f"{BASE_URL}{ENDPOINT}", json=happy_path_payload)
    if response.status_code == 201:
        created_resources.append(
            {
                "type": "test_post",
                "id": response.json()["id"],
                "endpoint": f"{BASE_URL}{ENDPOINT}/{response.json()['id']}",
            }
        )
        ...
        [
            pytest.param(
                "HAPPY_PATH",
                {
                    ...
                    "content": "Learn programming with Python, JavaScript, and more.",
                    "status": "DRAFT",
            ...
            pytest.param(
                ...
                {},
                422,
                id="BOUNDARY_MIN_ITEMS_MINUS_ONE",
            ),
            pytest.param(
                ...
                {},
                422,
                id="BOUNDARY_MAX_ITEMS_PLUS_ONE",
            ),
            pytest.param(
                "EMPTY_STRING",
                {
