...
# Operation: get_user_users__username__get
...
class TestGet_user_users__username__get:
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                "HAPPY_PATH", {}, {"username": "test_val"}, 200, id="HAPPY_PATH"
            ),
            pytest.param(
                "SQL_INJECTION",
                {},
    ...
    def test_get_user_users__username__get_contract(
        self, api_client, intent, payload, path_params, expected_status
    ):
        """
        Validates GET /users/{username} against the OpenAPI contract.
        Intent: {intent}
