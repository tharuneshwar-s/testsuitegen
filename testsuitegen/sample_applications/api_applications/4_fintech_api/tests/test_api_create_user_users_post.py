...
# Operation: create_user_users_post
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            {"email": "alicesmith@domain.com", "account_id": 10000},
            {},
            422,
        ...
        pytest.param(
            "REQUIRED_FIELD_MISSING",
            {"name": "Alice Smith", "email": "alicesmith@domain.com"},
            {},
            422,
            id="REQUIRED_FIELD_MISSING",
        ),
...
def test_create_user_users_post_contract(
    api_client, test_data_setup, intent, payload, path_params, expected_status
):
    """
    Validates POST /users against the OpenAPI contract.
    Intent: {intent}
