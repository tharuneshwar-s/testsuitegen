import pytest
from security_inputs import _detect_xss

# Auto-generated by TestSuiteGen
# Operation: _detect_xss
...
class Testdetectxss:
    ...
    def test__detect_xss_contract(self, intent, kwargs, expected_status):
        """
        Contract testing for _detect_xss.
        Intent: {intent}
